...
require github.com/antsbtw/otun-s-egress v0.0.0-20260806135147-05b79f60c90f // pin: branch feat/punch-observer-trace

require github.com/sagernet/sing v0.8.11-0.20260514110501-905ad103a4df

require (
	github.com/andybalholm/brotli v1.1.0 // indirect
	github.com/antsbtw/sing-quic v0.6.2-0.20260806135107-a5ce10433257 // indirect
